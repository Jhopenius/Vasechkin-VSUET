...
def clicked():
    if (selected.get() == 1):
        prm.configure(text="Вот код задачи №1:\n# -- coding: utf-8 --\nn = int(input())\ni = 1\nwhile i**2 < n:\nprint(i**2)\n  i = i + 1\n")
        ...
        prm.configure(text="Вот код задачи №2:\n# -- coding: utf-8 --\nn = int(input())\ni = 2\nprint(':;;:')\nwhile n % i != 0:\n    i += 1\nprint(i)\n")
        prm.grid(column=0, row=7)
        def cal_sum():
            n = int(a.get())
            i = 2
        ...
        prm.configure(text="Вот код задачи №3:\n# -- coding: utf-8 --\nn = int(input())\ni = 1\nl = 0\nprint(':;;:')\nwhile i < n:\n    i *= 2\n    l += 1\n    if i <= n:\n        print(i, l)\n")
        prm.grid(column=0, row=7)
        def cal_sum():
            n = int(a.get())
            i = 1
        ...
        prm.configure(text="Вот код задачи №4:\n# -- coding: utf-8 --\nx=int(input())\ny=int(input())\ni=1\nwhile x<=y:\n    if x==y:\n        break\n    x+=x/10\n    i+=1\nprint(i)\n")
        prm.grid(column=0, row=7)
        def cal_sum():
            x = int(a.get())
            y = int(b.get())
        ...
        prm.configure(text="Вот код задачи №5:\n# -- coding: utf-8 --\nl = 0\nwhile int(input()) != 0:\n    l += 1\nprint(':;;:')\nprint(l)\n")
        prm.grid(column=0, row=7)
        def cal_sum():
            l = 0
            while int(a.get()) != 0:
        ...
        prm.configure(text="Вот код задачи №6:\n# -- coding: utf-8 --\ns = 0\nl = 0\nn= int(input())\nwhile n != 0:\n    s += n\n    l += 1\n    n = int(input())\nprint(':;;:')\nprint(s / l)\n")
        prm.grid(column=0, row=7)
        def cal_sum():
            s = 0
            l = 0
        ...
        prm.configure(text="Вот код задачи №7:\n# -- coding: utf-8 --\nn = int(input())\ni = 0\nwhile n != 0:\n    z = int(input())\n    if (z != 0) and (n < z):\n        i += 1\n    n = z\nprint(':;;:')\nprint(i)\n")
        prm.grid(column=0, row=7)
        def cal_sum():
            n = int(a.get())
            i = 0
        ...
        prm.configure(text="Вот код задачи №8:\n# -- coding: utf-8 --\np = -1\nc = 0\nm = 0\nn = int(input())\nwhile n != 0:\n    if p == n:\n        c += 1\n    else:\n        p = n\n        m = max(m, c)\n        c = 1\n    n = int(input())\nm = max(m, c)\nprint(':;;:')\nprint(m)\n")
        prm.grid(column=0, row=7)
        def cal_sum():
            p = -1
            c = 0
...
win.title("Практическая работа 6 Васечкин В.М.")
